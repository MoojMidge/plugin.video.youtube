...
from ...constants import CONTENT, SORT, SORT_METHOD, SORT_ORDER
...
class ViewManager(object):
    ...
    def apply_sort_method(cls, context, **kwargs):
        sort_method = kwargs.get(SORT_METHOD, '__default__')
        ...
        while num_attempts_remaining and not context.sleep(0.1):
            ...
            cls.log.warning(('Unable to set sort method',
                             'Method: {sort_method}',
                             'ID:     {sort_id}'),
                            sort_method=sort_method,
                            sort_id=sort_id)
    ...
    @classmethod
    def apply_sort_order(cls, context, **kwargs):
