...
class ViewManager(object):
    ...
    STRING_MAP = {
        ...
        'movies': 30029,
        'songs': 30033,
        'sort_ascending': 21430,
        'sort_descending': 21431,
        'tvshows': 30032,
    }
    ...
    def apply_sort_dir(cls, context, **kwargs):
        ...
        if sort_dir == context.localize(cls.STRING_MAP['sort_ascending']):
            sort_dir = 'ascending'
        elif sort_dir == context.localize(cls.STRING_MAP['sort_descending']):
            sort_dir = 'descending'
        else:
            cls.log.debug('Invalid sort direction: %r', sort_dir)
            return
