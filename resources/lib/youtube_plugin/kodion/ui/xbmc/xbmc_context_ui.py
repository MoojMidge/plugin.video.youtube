...
class XbmcContextUI(AbstractContextUI):
    ...
    def set_property(self, property_id, value='true', stacklevel=1):
    ...
    def get_property(self, property_id, stacklevel=1):
        _property_id = '-'.join((ADDON_ID, property_id))
    ...
    def pop_property(self, property_id, stacklevel=1):
        _property_id = '-'.join((ADDON_ID, property_id))
    ...
    def clear_property(self, property_id, stacklevel=1):
